...
function Home() {
  return <div>
    <section className="hero"><div className="hero__content"><div className="eyebrow">THE FUTURE OF FREELANCE WORK</div><h1>Find the right talent.<br /><em>Build what's next.</em></h1><p>Connect with skilled freelancers who bring your ideas to life. Quality work, transparent pricing, and a community you can trust.</p><SearchBar /><div className="hero__trust"><span>Trusted by teams at</span><b>◈ Northstar</b><b>△ vertex</b><b>○ Layer</b></div></div><div className="hero__shape"><span>✦</span></div></section>
    ...
    <section className="cta container"><div><span className="eyebrow">ARE YOU A CREATIVE?</span><h2>Turn your skills into<br /><em>something bigger.</em></h2><p>Join thousands of freelancers earning on their own terms.</p><Link to="/register" className="button">Start selling your skills ↗</Link></div><div className="cta__graphic">✦</div></section>
  </div>;
}
export default Home;
